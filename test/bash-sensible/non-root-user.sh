...
check "The $RC_FILE_NAME [$RC_FILE_PATH] file contains a reference to the $SENSIBLE_FILE_NAME [$SENSIBLE_FILE_PATH] file" bash -c "sudo cat $RC_FILE_PATH | grep '$SENSIBLE_FILE_NAME' | grep -q source"
